    ...
    if (window.innerWidth > 1024) {
        if (character) {
            ...
            tl2
                ...
                .to(camera.position, { z: 75, y: 8.4, duration: 3, delay: 0, ease: "power3.inOut" }, 0)
                .fromTo(".character-model", { pointerEvents: "inherit" }, { pointerEvents: "none", x: "-12%", delay: 0, duration: 3 }, 0)
                ...
                .fromTo(monitor.position, { y: -10, z: 2 }, { y: 0, z: 0, delay: 0, duration: 2 }, 0)
                .fromTo(".character-rim", { opacity: 1, scaleX: 1.4 }, { opacity: 0, scale: 0, y: "-70%", duration: 3, delay: 0 }, 0.3)
            ...
            tl3
                .to(".character-model", { y: "-100%", opacity: 0, duration: 2, ease: "power2.inOut" }, 0)
